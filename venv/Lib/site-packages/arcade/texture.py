...
def load_texture(file_name: Union[str, Path],
    ...
    cache_name = ''.join(random.choices(string.ascii_letters + string.digits, k=10))  # noqa
    if can_cache and cache_name in load_texture.texture_cache and not img:  # type: ignore # dynamic attribute on function obj
...
def cleanup_texture_cache():
    ...
    print(load_texture.texture_cache)
